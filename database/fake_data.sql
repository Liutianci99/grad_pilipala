...
(10, 7, 3, 1, '2026-02-14 09:00:00', '2026-02-14 09:30:00', NULL,
 ...
 3500200, 3120, 4),
-- 待出发 (status=0)
(11, 5, 1, 0, '2026-02-16 08:00:00', NULL, NULL, NULL, NULL, NULL, 0),
...
-- ============================================================
-- 9. 实时位置 (delivery_location) — 配送中批次的GPS轨迹
-- batch_id 直接关联 delivery_batches.id
-- ============================================================
INSERT INTO delivery_location (id, batch_id, latitude, longitude, address, path_index, recorded_at) VALUES
-- 批次8路线: 张伟 从北京出发，当前在洛阳附近
(1,  8, 39.793421, 116.527834, '华北一号仓-出发',     0, '2026-02-14 08:30:00'),
(2,  8, 39.200000, 116.300000, '河北保定附近',         0, '2026-02-14 10:00:00'),
(3,  8, 38.500000, 116.200000, '石家庄中转站',         1, '2026-02-14 12:00:00'),
(4,  8, 37.500000, 115.300000, '河北邢台附近',         1, '2026-02-14 14:00:00'),
(5,  8, 36.600000, 114.500000, '邯郸中转站',           2, '2026-02-14 16:00:00'),
(6,  8, 35.800000, 113.600000, '河南安阳附近',         2, '2026-02-14 18:00:00'),
(7,  8, 34.700000, 112.500000, '洛阳中转站',           3, '2026-02-15 08:00:00'),
(8,  8, 34.200000, 111.000000, '三门峡附近',           3, '2026-02-15 10:00:00'),
(9,  8, 34.200000, 109.500000, '渭南附近',             4, '2026-02-15 12:00:00'),
(10, 8, 34.200000, 108.900000, '西安中转站',           4, '2026-02-15 14:00:00'),
(11, 8, 33.500000, 107.500000, '汉中附近',             5, '2026-02-15 16:00:00'),
-- 批次9路线: 李强 从上海出发，当前在武汉
(12, 9, 31.302547, 121.329876, '华东中心仓-出发',     0, '2026-02-14 09:00:00'),
(13, 9, 31.100000, 120.200000, '苏州附近',             0, '2026-02-14 10:30:00'),
(14, 9, 31.000000, 119.000000, '常州中转站',           1, '2026-02-14 12:00:00'),
(15, 9, 31.500000, 117.800000, '南京附近',             1, '2026-02-14 14:00:00'),
(16, 9, 31.800000, 117.200000, '合肥中转站',           2, '2026-02-14 16:00:00'),
(17, 9, 31.200000, 115.800000, '黄冈附近',             2, '2026-02-14 18:00:00'),
(18, 9, 30.553780, 114.352950, '武汉-吴志远 已送达',   3, '2026-02-15 08:00:00'),
-- 批次10路线: 王磊 从广州出发，当前在合肥附近
(19, 10, 23.256432, 113.298765, '华南智能仓-出发',     0, '2026-02-14 09:30:00'),
(20, 10, 24.200000, 113.500000, '清远附近',             0, '2026-02-14 11:00:00'),
(21, 10, 24.800000, 113.600000, '韶关中转站',           1, '2026-02-14 13:00:00'),
(22, 10, 26.000000, 114.000000, '赣州附近',             1, '2026-02-14 16:00:00'),
(23, 10, 27.100000, 114.300000, '吉安中转站',           2, '2026-02-14 18:00:00'),
(24, 10, 28.700000, 115.800000, '南昌中转站',           3, '2026-02-15 08:00:00'),
(25, 10, 30.200000, 116.500000, '安庆附近',             3, '2026-02-15 10:00:00'),
(26, 10, 31.800000, 117.000000, '合肥中转站',           4, '2026-02-15 12:00:00');
...
-- 地址: 12个
-- 密码: 全部为 "123"
-- 配送员仓库: 直接存在 users.warehouse_id
-- 路线数据: 直接存在 delivery_batches.route_data
-- ============================================================
